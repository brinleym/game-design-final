...
public class Loader2 : MonoBehaviour
{
	...
	void Start()
	{
		...
		Instantiate(player3, new Vector3(9, 1, 0f), Quaternion.identity);

		Instantiate(door, new Vector3(8, 12.5f, 0f), Quaternion.identity);
		//Instantiate(exit, new Vector3(8, 13, 0), Quaternion.identity);

		Instantiate(locks[0], new Vector3(6, 11, 0f), Quaternion.identity);
		Instantiate(locks[1], new Vector3(8, 11, 0f), Quaternion.identity);
		Instantiate(locks[2], new Vector3(10, 11, 0f), Quaternion.identity);
